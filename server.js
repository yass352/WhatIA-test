...
const INTENTS = [
  ...
  { name: 'destination_couverte', priority: 70, handoff: false, tests: [/\bbangladesh\b/i, /\binde\b/i, /\bSri\s+Lanka\b/i, /\bMali\b/i, /\bS[eé]n[eé]gal\b/i, /\bGuin[eé]e\b/i, /\bRDC\b/i, /\bdesservons?\b/i], response: 'Nous travaillons principalement sur les destinations d’Asie du Sud et d’Afrique subsaharienne.\nIndiquez-nous la destination souhaitée et nous vous confirmerons si nous pouvons vous proposer une solution.' },
  ...
  { name: 'agent_disponible', priority: 58, handoff: false, tests: [/\bagent\s+disponible\b/i, /\bconseiller\s+disponible\b/i, /\best\s+quelqu'un\s+disponible\b/i], response: 'Tous nos agents sont disponibles selon leur planning.' },
  ...
  { name: 'salutation', priority: 40, handoff: false, tests: [/\bbonjour\b/i, /\bsalut\b/i, /\bbjr\b/i, /\bhi\b/i, /\bhello\b/i, /\bsalam\b/i], response: 'Bonjour / Hi / Hello / Salam, en quoi puis-je vous aider ?\nSi vous souhaitez connaître les tarifs, merci de nous indiquer :\nvotre destination,\nvotre ville de départ et votre ville de retour,\nvos dates de départ et de retour,\nle nombre de passagers,\nvotre préférence éventuelle : compagnie aérienne, vol direct ou prix le plus bas.\nUn agent vous indiquera le meilleur prix actuel.' }
